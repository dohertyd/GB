...
public class TapTelegraph_sendTap_rspArg
{
    ...
    public TapTelegraph_sendTap_rspArg(){
        this(true);
    }

    public TapTelegraph_sendTap_rspArg(boolean isSetDefault){
        super();
    ...
    public TapTelegraph_sendTap_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_sendTap_rspArg(String payload){
