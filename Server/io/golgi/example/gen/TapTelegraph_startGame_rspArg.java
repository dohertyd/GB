...
public class TapTelegraph_startGame_rspArg
{
    ...
    public TapTelegraph_startGame_rspArg(){
        this(true);
    }

    public TapTelegraph_startGame_rspArg(boolean isSetDefault){
        super();
    ...
    public TapTelegraph_startGame_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_startGame_rspArg(String payload){
