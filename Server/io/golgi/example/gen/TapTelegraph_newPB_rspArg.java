...
public class TapTelegraph_newPB_rspArg
{
    ...
    public TapTelegraph_newPB_rspArg(){
        this(true);
    }

    public TapTelegraph_newPB_rspArg(boolean isSetDefault){
        super();
    ...
    public TapTelegraph_newPB_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_newPB_rspArg(String payload){
