...
public class TapTelegraph_gameOver_rspArg
{
    ...
    public TapTelegraph_gameOver_rspArg(){
        this(true);
    }

    public TapTelegraph_gameOver_rspArg(boolean isSetDefault){
        super();
    ...
    public TapTelegraph_gameOver_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_gameOver_rspArg(String payload){
