...
public class TapTelegraph_getHiScore_rspArg
{
    ...
    public HiScoreData getResult(){
        return result;
    }
    public boolean resultIsSet(){
        return resultIsSet;
    }
    public void setResult(HiScoreData result){
        this.result = result;
    ...
    private void deserialise(GolgiPayload payload){
        ...
        if(!isCorrupt() && payload.containsNestedKey("2")){
            HiScoreData inst = new HiScoreData(payload.getNested("2"));
            setResult(inst);
        }
    ...
    public TapTelegraph_getHiScore_rspArg(){
        this(true);
    }

    public TapTelegraph_getHiScore_rspArg(boolean isSetDefault){
        super();
        internalSuccess_IsSet = isSetDefault;
        internalSuccess_ = 0;
        resultIsSet = isSetDefault;
        result = new HiScoreData(isSetDefault);
        golgiExceptionIsSet = isSetDefault;
        golgiException = new GolgiException(isSetDefault);
    }

    public TapTelegraph_getHiScore_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_getHiScore_rspArg(String payload){
