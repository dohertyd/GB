...
public class TapTelegraph_streamGame_rspArg
{
    ...
    public TapTelegraph_streamGame_rspArg(){
        this(true);
    }

    public TapTelegraph_streamGame_rspArg(boolean isSetDefault){
        super();
    ...
    public TapTelegraph_streamGame_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_streamGame_rspArg(String payload){
