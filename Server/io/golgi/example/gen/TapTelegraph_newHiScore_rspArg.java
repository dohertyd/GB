...
public class TapTelegraph_newHiScore_rspArg
{
    ...
    public TapTelegraph_newHiScore_rspArg(){
        this(true);
    }

    public TapTelegraph_newHiScore_rspArg(boolean isSetDefault){
        super();
    ...
    public TapTelegraph_newHiScore_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TapTelegraph_newHiScore_rspArg(String payload){
